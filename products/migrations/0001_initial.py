# Generated by Django 5.2.8 on 2025-12-07 11:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_ar', models.CharField(blank=True, db_index=True, max_length=120, null=True)),
                ('name_en', models.CharField(blank=True, db_index=True, max_length=120, null=True)),
                ('subtitle', models.TextField(blank=True, max_length=500, null=True)),
                ('subtitle_ar', models.TextField(blank=True, max_length=500, null=True)),
                ('subtitle_en', models.TextField(blank=True, max_length=500, null=True)),
                ...
                ('description_ar', models.TextField(blank=True, max_length=50000, null=True)),
                ('description_en', models.TextField(blank=True, max_length=50000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='variant_colors', to='products.color')),
