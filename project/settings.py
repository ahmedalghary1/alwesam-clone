...
SECRET_KEY = 'django-insecure-hcde(hu+oq^tno9-ls$%y!gn0j+q!vrf)1^7e41h%j=g&)og$-'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ahmedalgohary1170@gmail.com'  # يجب تحديثه
EMAIL_HOST_PASSWORD = 'ypid mhkj dsxv xoaj'  # يجب تحديثه
